...
export default function LogoAndAvatar() {
  ...
  return (
    <div onClick={() => setChangeLogo(!changeLogo)} className="size-14 cursor-pointer">
      ...
      <Image className={`size-14 hover:scale-105 duration-300 transition-all ${!changeLogo ? '-translate-y-14' : 'translate-y-12 opacity-0 pointer-events-none'}`} src="https://avatar.spoverlay.ru/face/d1yy?w=128" alt="мой minecraft скин" width={56} height={56} />
    </div>
  )
}